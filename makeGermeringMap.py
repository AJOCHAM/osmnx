...
###############################################################################
# Define city/cities
places = ["Germering, Bavaria, Germany"]
...
###############################################################################
# Center of map
latitude = 48.130329354607916
longitude =  11.372426915439592 
...
# Make Map
fig, ax = ox.plot.plot_graph(G, node_size=0, bbox = (north, south, east, west),
                        figsize=(40, 40), dpi = 600,  bgcolor = "#000000",
...
# Save figure
fig.savefig("Germering.png", dpi=300, bbox_inches='tight', format="png", facecolor=fig.get_facecolor(), transparent=True)
...
# Add border
def add_border(input_image, output_image, fill = '#000000', bottom = 50, left = None, right = None, top = None):
    ...
    bimg = expand(img, bottom = bottom, left = left, right = right, top = top, fill= '#000000')
...
###############################################################################
# Input image 
in_img = 'Germering.png'

# Output Image
add_border(in_img, output_image='Germering.png', fill = '#000000', bottom = 800)
...
###############################################################################
# Open Image
img = Image.open("Germering.png")
draw = ImageDraw.Draw(img)

# Get font from working directory. Visit https://www.wfonts.com/search?kwd=pmingliu to download fonts
font = ImageFont.truetype("ruler.ttf", 650)

# Add font: position, text, color, font
draw.text((150,800),"Germering", (255,255,255), font=font)

# Save image
img.save('Germering.png')